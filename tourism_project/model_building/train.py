...
param_grid = {
    'xgbclassifier__n_estimators': [50, 100],    # number of tree to build
    'xgbclassifier__max_depth': [3],    # maximum depth of each tree
    'xgbclassifier__colsample_bytree': [0.5, 0.7],    # percentage of attributes to be considered (randomly) for each tree
    'xgbclassifier__learning_rate': [0.05, 0.1],    # learning rate
    'xgbclassifier__reg_lambda': [0.5],    # L2 regularization factor
}
